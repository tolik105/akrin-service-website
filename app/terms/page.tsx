...
const privacy = () => {
  return (
    <Container
      title="Terms and Conditions | Akrin IT Services"
      className="pb-20 max-w-[90rem] mx-auto"
      description="Terms and Conditions at Akrin IT Infrastructure Services"
    >
      <div className="prose prose-sm mx-auto">
        ...
        <p>Welcome to Akrin IT Infrastructure Services!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Akrin IT Infrastructure Services' Website, located at
          https://akrin.jp.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Akrin if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Akrin, you agreed
          to use cookies in agreement with the Akrin Solutions Private
        ...
        <p>
          Unless otherwise stated, Akrin IT Infrastructure Services
          and/or its licensors own the intellectual property rights for all
          material on Akrin. All intellectual property rights are
          reserved. You may access this from Akrin for your own
        ...
        <p>You must not:</p>
        <ul>
          <li>Republish material from Akrin</li>
          <li>Sell, rent or sub-license material from Akrin</li>
          <li>Reproduce, duplicate or copy material from Akrin</li>
          <li>Redistribute content from Akrin</li>
        </ul>
        ...
        <p>
          ...
          Akrin IT Infrastructure Services does not filter, edit,
          publish or review Comments prior to their presence on the website.
          Comments do not reflect the views and opinions of Akrin
          IT Infrastructure Services, its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Akrin
          IT Infrastructure Services shall not be liable for the Comments or for
        ...
        <p>
          Akrin IT Infrastructure Services reserves the right to
        ...
        <p>
          You hereby grant Akrin IT Infrastructure Services a
        ...
        <p>
          ...
          the hyperlink compensates the absence of Akrin Solutions
        ...
        <p>
          ...
          sending an e-mail to Akrin IT Infrastructure Services. Please
        ...
        <p>
          No use of Akrin IT Infrastructure Services's logo or other
