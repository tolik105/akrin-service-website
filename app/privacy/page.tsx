...
const privacy = () => {
  return (
    <Container
      title="Privacy Policy | Akrin IT Services"
      className="pb-20 max-w-[90rem] mx-auto"
      description="Privacy Policy at Akrin"
    >
      <div className="prose prose-sm mx-auto">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Akrin IT Infrastructure Services,
              Tokyo, Japan.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Tokyo, Japan
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Akrin IT Infrastructure Services,
              accessible from{" "}
              <a
                href="https://akrin.jp"
        ...
        <ul>
          <li>
            <p>By email: youremail@yourgmail.com</p>
          </li>
          <li>
            <p>
